...
void VerticalLayout::paint(int x, int y, int width, int height, vector<shared_ptr<WindowElement>> elements) {
...
bool VerticalLayout::selectNext(WindowElement* selectedElement, vector<shared_ptr<WindowElement>> elements, ArrowKey direction) {
    int currentIndex = -1;
    for (int i = 0; i < elements.size(); i++) {
