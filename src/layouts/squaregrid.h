...
void SquareGridLayout::paint(int x, int y, int width, int height, vector<shared_ptr<WindowElement>> elements) {
...
bool SquareGridLayout::selectNext(WindowElement* selectedElement, vector<shared_ptr<WindowElement>> elements, ArrowKey direction) {
